...
public class PreferenceUtils {
     ...
     * @param myLocation
     */
    public static void setUserLocation(Context context, LocationUtils.MyLocation myLocation) {
        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(context).edit();
     ...
     * @return
     */
    public static LocationUtils.MyLocation getUserLocation(Context context) {
        ...
        LocationUtils.MyLocation myLocation = new LocationUtils.MyLocation();
